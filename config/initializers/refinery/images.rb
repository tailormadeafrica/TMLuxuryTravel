Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:small=>"110x110>", :medium=>"225x255>", :large=>"750x450>"}
  ...
  # config.datastore_root_path = "C:/Dev/Workspace/tailor_made_africa/tailor_made_africa/public/system/refinery/images"
